        ...
        pages={[
            {
                ...
                image: <Image source={require('../assets/triangle.png')} style={styles.logo} />,
                title: 'Learn to Love Exercise',
                subtitle: 'Grow with your gains',
            },
            {
                backgroundColor: '#ffe289',
                image: <Image source={require('../assets/plan.png')} style={styles.logo} />,
                title: 'Stay on Track',
                subtitle: 'Create routines that work for you',
            },
            {
                backgroundColor: '#85998a',
                image: <Image source={require('../assets/dumbbell.png')} style={styles.logo}/>,
