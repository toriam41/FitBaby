  ...
  render() {
    ...
    for (let i = scenes.length - 1; i >= 0; i--) {
      ...
      const {
        ...
        detachPreviousScreen = options.presentation === 'transparentModal' ? false : (0, _Card.getIsModalPresentation)(options.cardStyleInterpolator) ? i !== scenes.map(scene => scene.descriptor.options.cardStyleInterpolator.name).lastIndexOf('forModalPresentationIOS') : true
      } = options;
