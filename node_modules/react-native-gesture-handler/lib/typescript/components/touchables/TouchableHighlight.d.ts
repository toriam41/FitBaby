...
import { TouchableHighlightProps, ColorValue } from 'react-native/types';
interface State {
...
export default class TouchableHighlight extends Component<TouchableHighlightProps & GenericTouchableProps, State> {
    ...
    showUnderlay: () => void;
    hasPressHandler: () => (((event: import("react-native/types").GestureResponderEvent) => void) & (() => void)) | undefined;
    hideUnderlay: () => void;
